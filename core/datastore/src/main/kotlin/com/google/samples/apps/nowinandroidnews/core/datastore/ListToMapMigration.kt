 ...
 */
object ListToMapMigration : DataMigration<com.google.samples.apps.nowinandroidnews.core.datastore.UserPreferences> {

    override suspend fun cleanUp() = Unit

    override suspend fun migrate(currentData: com.google.samples.apps.nowinandroidnews.core.datastore.UserPreferences): com.google.samples.apps.nowinandroidnews.core.datastore.UserPreferences =
        currentData.copy {
    ...
    override suspend fun shouldMigrate(currentData: com.google.samples.apps.nowinandroidnews.core.datastore.UserPreferences): Boolean {
